...
namespace Microsoft.Samples.Kinect.WpfViewers
{
    ...
    public partial class KinectSensorChooser : UserControl
    {
        ...
        public KinectSensorChooser()
        {
            ...
            Binding binding = new Binding("Mensaje") { Source = this };
            MessageTextBlock.SetBinding(TextBlock.TextProperty, binding);
            Binding binding2 = new Binding("Mas informacion") { Source = this };
            TellMeMoreLink.SetBinding(TextBlock.ToolTipProperty, binding2);
            Binding binding3 = new Binding("Mas informacion") { Source = this, Converter = new NullToVisibilityConverter() };
